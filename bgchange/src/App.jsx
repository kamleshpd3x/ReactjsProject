  ...
  return (
    ...
    style = {{backgroundColor: color}}>
      ...
      <div className = "fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
        ...
        <button onClick= {()=> setColor("yellow")} className = "outline-none px-4 py-1 rounded-full text-white shadow-sm" style={{backgroundColor: "grey"}}>yellow</button>
        ...
        <button onClick= {()=> setColor("purple")} className = "outline-none px-4 py-1 rounded-full text-white shadow-sm" style={{backgroundColor: "purple"}}>Blue</button>
